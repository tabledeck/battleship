  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        forest:      '#214634',
        grid:        { paper: '#faf3e3', steel: '#17294b' },
        peg:         { hit: '#c8372a', hitHi: '#e15a44', miss: '#f2eadb', missLo: '#b8ad91' },
      },
      fontFamily: {
      ...
      boxShadow: {
        ...
        'board-frame': 'inset 0 1px 0 rgba(100,150,220,0.2), inset 0 -2px 0 rgba(0,0,0,0.5), 0 12px 28px rgba(0,0,0,0.7)',
      },
    },
  },
} satisfies Config;
