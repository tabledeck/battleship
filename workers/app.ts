...
export { BattleshipRoomDO } from "./game-room";
...
export default {
  async fetch(
    ...
    // Redirect root and www to the battleship subdomain
    if (url.hostname === "tabledeck.us" || url.hostname === "www.tabledeck.us") {
      return Response.redirect(`https://battleship.tabledeck.us${url.pathname === "/" ? "" : url.pathname}`, 302);
    }
